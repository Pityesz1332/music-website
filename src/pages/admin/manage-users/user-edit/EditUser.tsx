...
export const EditUser = ({ user, onClose, onSave, onChange }: EditUserProps) => {
    ...
    return (
        ...
        >
            <div className="manage-users__form-content">
                <div className="manage-users__form-group">
                    ...
                    <input className="manage-users__input" type="text" value={user.name} onChange={handleFieldChange("name")}/>
                </div>
                <div className="manage-users__form-group">
                ...
                <div className="manage-users__form-group">
                    ...
                    <select className="manage-users__select" value={user.role} onChange={handleFieldChange("role")}>
